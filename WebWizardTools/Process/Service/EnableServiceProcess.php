...
class EnableServiceProcess extends LightDeveloperWizardCommonProcess
{
    ...
    public function __construct()
    {
        ...
        $this->setLearnMore('See the <a target="_blank" href="https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/pages/task-details.md#enable-service">Enable service task detail</a>.');
    }
