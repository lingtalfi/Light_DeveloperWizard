...
- Methods
    - public [__construct](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/api/Ling/Light_DeveloperWizard/WebWizardTools/Process/Light_Cli/CreateCliAppProcess/__construct.md)() : void
    - protected [doExecute](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/api/Ling/Light_DeveloperWizard/WebWizardTools/Process/Light_Cli/CreateCliAppProcess/doExecute.md)(?array $options = []) : void
    - private [getAlias](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/api/Ling/Light_DeveloperWizard/WebWizardTools/Process/Light_Cli/CreateCliAppProcess/getAlias.md)(string $planet) : string
...
- [CreateCliAppProcess::__construct](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/api/Ling/Light_DeveloperWizard/WebWizardTools/Process/Light_Cli/CreateCliAppProcess/__construct.md) &ndash; Builds the WebWizardToolsProcess instance.
- [CreateCliAppProcess::doExecute](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/api/Ling/Light_DeveloperWizard/WebWizardTools/Process/Light_Cli/CreateCliAppProcess/doExecute.md) &ndash; Executes the process.
- [CreateCliAppProcess::getAlias](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/api/Ling/Light_DeveloperWizard/WebWizardTools/Process/Light_Cli/CreateCliAppProcess/getAlias.md) &ndash; Returns an app alias from the given planet name.
...
Location
=============
Ling\Light_DeveloperWizard\WebWizardTools\Process\Light_Cli\CreateCliAppProcess<br>
See the source code of [Ling\Light_DeveloperWizard\WebWizardTools\Process\Light_Cli\CreateCliAppProcess](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/WebWizardTools/Process/Light_Cli/CreateCliAppProcess.php)



SeeAlso
==============
Previous class: [LightDeveloperWizardCommonProcess](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/api/Ling/Light_DeveloperWizard/WebWizardTools/Process/LightDeveloperWizardCommonProcess.md)<br>Next class: [CreateLkaGeneratorConfigProcess](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/api/Ling/Light_DeveloperWizard/WebWizardTools/Process/Light_Kit_Admin/CreateLkaGeneratorConfigProcess.md)<br>
