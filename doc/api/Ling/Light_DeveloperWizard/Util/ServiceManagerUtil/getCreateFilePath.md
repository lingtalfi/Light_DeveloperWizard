...
ServiceManagerUtil::getCreateFilePath
================



ServiceManagerUtil::getCreateFilePath — Returns the path to the create file for this service.
...
public [ServiceManagerUtil::getCreateFilePath](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/api/Ling/Light_DeveloperWizard/Util/ServiceManagerUtil/getCreateFilePath.md)() : string
...
Source Code
===========
See the source code for method [ServiceManagerUtil::getCreateFilePath](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/Util/ServiceManagerUtil.php#L367-L370)
