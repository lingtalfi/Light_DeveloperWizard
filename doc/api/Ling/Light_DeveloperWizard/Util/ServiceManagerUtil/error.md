...
Source Code
===========
See the source code for method [ServiceManagerUtil::error](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/Util/ServiceManagerUtil.php#L681-L684)
