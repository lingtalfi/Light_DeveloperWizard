...
class HelpCommand extends LightPlanetInstallerBaseCommand
{
    ...
    protected function doRun(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->write("For more information see our planet: https://github.com/lingtalfi/Light_PlanetInstallerXXX" . PHP_EOL);
...
//        $output->write(H::j(1) . $this->o("indent=\$number") . ": sets the base indentation level used by most commands." . PHP_EOL);
    ...
    public function getDescription(): string
    {
        ...
        return "
 This command shows the help for the <b>Light_PlanetInstallerXXX</b> planet.
 ";
    }
